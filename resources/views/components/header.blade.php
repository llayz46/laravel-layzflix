                ...
                <div class="flex items-center px-6 py-4 md:mx-auto md:max-w-3xl lg:mx-0 lg:max-w-none xl:px-0">
                    <div class="w-full">
                        ...
                        <div class="relative">
                            ...
                            <input id="search" name="search" class="@if($inputTransparent) bg-transparent ring-gray-700 text-white @else bg-background ring-gray-300 text-title @endif block w-full rounded-md dark:ring-gray-700 border-0 py-1.5 pl-10 pr-3 ring-1 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-500 dark:focus:ring-primary-500 sm:text-sm sm:leading-6" placeholder="Search a movie" type="search">
                        </div>
                    </div>
                </div>
            </div>
